                ...
                <div class="flex-1">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <small class="ml-2 text-sm text-gray-600">{{ $chirp->created_at->format('j M Y, g:i a') }} <small class="text-sm text-gray-600"> &middot;</small> {{ __('edited') }} {{ $chirp->updated_at->format('j M Y, g:i a') }}</small>
                        </div>
                    </div>
